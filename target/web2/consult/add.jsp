...
<div class="panel admin-panel">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加就诊信息</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="/con/consave">
            ...
            <div class="form-group">
                ...
                <div class="datetime">
                <input type="datetime-local" class="input w50" name="consultationTime" step="1">
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="medicalAdviceCase" />
                </div>
            </div>
            <div class="form-group">
                <div class="label">
