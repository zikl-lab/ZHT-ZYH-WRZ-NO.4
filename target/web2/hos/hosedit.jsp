...
<div class="panel admin-panel margin-top">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="/hos/hosedit">
            <div class="form-group">
                <div class="label">
                    <label>编号：</label>
                </div>
                <div class="field">
                    <select name="hosId" class="input w50">
                        <c:forEach items="${hospitalization}" var="hos">
                            <option value="${hos.hospitalizationId}">${hos.hospitalizationId}</option>
                        </c:forEach>
                    </select>
