...
@WebServlet("/doc/docinfedit")
public class DoctorsinfEditServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            //修改成功
            resp.sendRedirect("/doc/docinflist");
        }catch (NumberFormatException e){
            //throw new RuntimeException(e);
            e.printStackTrace();
            //修改失败
            resp.sendRedirect("/doc/docinftoedit?doctorsId="+id);
        }
