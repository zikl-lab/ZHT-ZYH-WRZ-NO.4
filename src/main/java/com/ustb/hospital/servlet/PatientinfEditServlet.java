...
@WebServlet("/pat/patinfedit")
public class PatientinfEditServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            resp.sendRedirect("/pat/Ppatlist");
        } catch (Exception e) {
            e.printStackTrace();
            /*throw new RuntimeException(e);*/
            resp.sendRedirect("/pat/patinftoedit?patientIdCard="+patientIdCard);
        }
