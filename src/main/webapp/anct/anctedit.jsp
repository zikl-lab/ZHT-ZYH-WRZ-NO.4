...
<div class="panel admin-panel margin-top">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="/anct/anctedit">
            <div class="form-group">
                <div class="label">
                    <label>编号：</label>
                </div>
                <div class="field">
                    <select name="announcementId" class="input w50">
                        <c:forEach items="${announcements}" var="anct">
                            <option value="${anct.announcementId}">${anct.announcementId}</option>
                        </c:forEach>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="creator"  />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
